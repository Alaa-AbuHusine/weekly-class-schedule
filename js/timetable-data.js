...
const DEFAULT_TIMETABLE_DATA = {
  sunday: {
    1: {
      ...
      '9c': { subject: 'جغرافيا', teacher: 'يوسف مدالله' },
      '9d': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
    ...
    4: {
      ...
      '10b': { subject: 'فيزياء', teacher: 'كرم' },
    ...
    6: {
      ...
      '9c': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '9d': { subject: 'دين', teacher: 'إبراهيم' },
      '9e': { subject: 'وطنية', teacher: 'عمر فهد' },
      '10a': { subject: 'فيزياء', teacher: 'كرم' },
    ...
    7: {
      ...
      '9d': { subject: 'مهني', teacher: 'علي الفواعرة' },
      '9e': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '10a': null,
      '10b': null,
  ...
  monday: {
    ...
    3: {
      ...
      '9a': { subject: 'فيزياء', teacher: 'كرم' },
      '9b': { subject: 'مالية', teacher: 'مالك صبيحات' },
      '9c': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '9d': { subject: 'دين', teacher: 'إبراهيم' },
      '9e': { subject: 'رياضيات', teacher: 'يمان' },
      '10a': { subject: 'وطنية', teacher: 'عمر فهد' },
      '10b': { subject: 'انجليزي', teacher: 'عليق' },
      '10c': { subject: 'وطنية', teacher: 'يوسف مدالله' }
    },
    4: {
      '8a': { subject: 'اجتماعيات', teacher: 'عمر فهد' },
      '8b': { subject: 'انجليزي', teacher: 'علاء' },
      ...
      '9b': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '9c': { subject: 'انجليزي', teacher: 'مروان' },
      '9d': { subject: 'علوم ارض', teacher: 'الشرعه' },
      '9e': { subject: 'انجليزي', teacher: 'عليق' },
      '10a': { subject: 'عربي', teacher: 'عبد الرحيم' },
      '10b': { subject: 'رياضيات', teacher: 'يمان' },
      '10c': { subject: 'مالية', teacher: 'مالك صبيحات' }
    },
    5: {
      '8a': { subject: 'عربي', teacher: 'يزيد' },
      '8b': { subject: 'رياضيات', teacher: 'محمد اللاحم' },
    ...
    7: {
      ...
      '10b': { subject: 'رياضة', teacher: 'علي صبيحات' },
      '10c': { subject: 'عربي', teacher: 'عبد الرحيم' }
    }
  },
  tuesday: {
    1: {
      ...
      '9c': { subject: 'رياضيات', teacher: 'عبد الحميد' },
      '9d': { subject: 'عربي', teacher: 'مؤمن' },
      '9e': { subject: 'جغرافيا', teacher: 'يوسف مدالله' },
      '10a': { subject: 'رياضيات', teacher: 'يمان' },
      '10b': { subject: 'مالية', teacher: 'مالك صبيحات' },
    ...
    2: {
      ...
      '9d': { subject: 'جغرافيا', teacher: 'يوسف مدالله' },
      '9e': { subject: 'عربي', teacher: 'عبد الرحيم' },
      '10a': { subject: 'فيزياء', teacher: 'كرم' },
    ...
    3: {
      ...
      '10a': { subject: 'عربي', teacher: 'عبد الرحيم' },
      '10b': { subject: 'دين', teacher: 'إبراهيم' },
      '10c': { subject: 'حاسوب', teacher: 'يوسف النعيمي' }
    },
    4: {
      ...
      '10a': { subject: 'انجليزي', teacher: 'عليق' },
      '10b': { subject: 'عربي', teacher: 'عبد الرحيم' },
      '10c': { subject: 'فيزياء', teacher: 'كرم' }
    },
    5: {
      '8a': { subject: 'عربي', teacher: 'يزيد' },
      '8b': { subject: 'اجتماعيات', teacher: 'يوسف مدالله' },
      ...
      '9c': { subject: 'دين', teacher: 'إبراهيم' },
      '9d': { subject: 'عربي', teacher: 'مؤمن' },
      '9e': { subject: 'مالية', teacher: 'مالك صبيحات' },
      '10a': { subject: 'كيمياء', teacher: 'عليمات' },
      '10b': { subject: 'رياضيات', teacher: 'يمان' },
      '10c': { subject: 'عربي', teacher: 'عبد الرحيم' }
    },
    6: {
      ...
      '9e': { subject: 'رياضيات', teacher: 'يمان' },
      '10a': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '10b': { subject: 'انجليزي', teacher: 'عليق' },
      '10c': { subject: 'دين', teacher: 'إبراهيم' }
    },
    7: {
      ...
      '9c': { subject: 'عربي', teacher: 'مؤمن' },
      '9d': { subject: 'انجليزي', teacher: 'مروان' },
      '9e': { subject: 'رياضة', teacher: 'علي صبيحات' },
      '10a': null,
      '10b': null,
      '10c': { subject: 'انجليزي', teacher: 'عليق' }
    }
  ...
  wednesday: {
    ...
    2: {
      ...
      '9e': { subject: 'عربي', teacher: 'عبد الرحيم' },
      '10a': { subject: 'دين', teacher: 'إبراهيم' },
      '10b': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '10c': { subject: 'انجليزي', teacher: 'عليق' }
    },
    3: {
      '8a': { subject: 'علوم', teacher: 'كرم' },
      ...
      '9a': { subject: 'دين', teacher: 'نايل' },
      '9b': { subject: 'عربي', teacher: 'مؤمن' },
      '9c': { subject: 'مالية', teacher: 'مالك صبيحات' },
      '9d': { subject: 'رياضيات', teacher: 'عبد الحميد' },
    ...
    4: {
      ...
      '8c': { subject: 'دين', teacher: 'نايل' },
      '8d': { subject: 'عربي', teacher: 'يزيد' },
      '9a': { subject: 'مالية', teacher: 'مالك صبيحات' },
      '9b': { subject: 'رياضيات', teacher: 'عبد الحميد' },
      '9c': { subject: 'انجليزي', teacher: 'مروان' },
      '9d': { subject: 'فيزياء', teacher: 'كرم' },
      '9e': { subject: 'دين', teacher: 'إبراهيم' },
      '10a': { subject: 'جغرافيا', teacher: 'يوسف مدالله' },
    ...
    6: {
      ...
      '8d': { subject: 'رياضة', teacher: 'علي صبيحات' },
      '9a': { subject: 'حاسوب', teacher: 'يوسف النعيمي' },
      '9b': { subject: 'رياضة', teacher: 'علي صبيحات' },
      '9c': { subject: 'رياضيات', teacher: 'عبد الحميد' },
      '9d': { subject: 'عربي', teacher: 'مؤمن' },
      '9e': { subject: 'رياضيات', teacher: 'يمان' },
      '10a': { subject: 'انجليزي', teacher: 'عليق' },
  ...
  thursday: {
    1: {
      ...
      '9e': { subject: 'فيزياء', teacher: 'كرم' },
      '10a': { subject: 'انجليزي', teacher: 'عليق' },
      '10b': { subject: 'جغرافيا', teacher: 'يوسف مدالله' },
      '10c': { subject: 'رياضيات', teacher: 'يمان' }
    },
    2: {
      '8a': { subject: 'دين', teacher: 'نايل' },
      ...
      '9d': { subject: 'مالية', teacher: 'مالك صبيحات' },
    ...
    5: {
      ...
      '9d': { subject: 'رياضيات', teacher: 'عبد الحميد' },
      '9e': { subject: 'انجليزي', teacher: 'عليق' },
      '10a': { subject: 'مالية', teacher: 'مالك صبيحات' },
      '10b': { subject: 'رياضيات', teacher: 'يمان' },
      '10c': { subject: 'دين', teacher: 'إبراهيم' }
    },
    6: {
      '8a': { subject: 'علوم', teacher: 'كرم' },
      '8b': { subject: 'رياضة', teacher: 'علي صبيحات' },
